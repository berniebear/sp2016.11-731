...
#feat_all = np.hstack((f_match,f_match_r,f_match_pos, f_match_pos_r, f_2gram, f_w2v))
feat_all = feat_all
...
model = Sequential()
model.add(Dense(500, input_shape=(dim,), init ='lecun_uniform'))
