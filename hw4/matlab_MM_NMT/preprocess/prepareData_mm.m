function [data] = prepareData_mm(srcFc7, srcSents, tgtSents, isTest, params, varargin)
...
%   hence srcMaxLen = 1
%  Po-Yao Huang, prepare data with multiple modalities
