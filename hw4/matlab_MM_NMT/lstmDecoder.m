  ...
  for mm=1:numModels
    ...
    encRnnFlags = struct('decode', 0, 'test', 1, 'attn', models{mm}.params.attnFunc, 'feedInput', 0);
      if encRnnFlags.attn %&& rnnFlags.decode == 0 % encoder
        ...
        %modelData{mm}.srcHidVecsOrig = zeroMatrix([models{mm}.params.lstmSize, models{mm}.params.curBatchSize, models{mm}.params.numSrcHidVecs*3], models{mm}.params.isGPU, models{mm}.params.dataType);
      end
    
    
    [encStates1, modelData{mm}, ~] = rnnLayerForward_enc(models{mm}.b_img, models{mm}.W_img, models{mm}.W_src, models{mm}.W_emb_src, zeroStates{mm}, modelData{mm}.srcInput, ...
      modelData{mm}.srcMask, modelData{mm}.imgMask, models{mm}.params, encRnnFlags, modelData{mm}, models{mm}, 1, []);
    lastEncState1 = encStates1{end};
    [encStates2, modelData{mm}, ~] = rnnLayerForward_enc(models{mm}.b_img, models{mm}.W_img, models{mm}.W_src, models{mm}.W_emb_src, zeroStates{mm}, modelData{mm}.srcInput, ...
      modelData{mm}.srcMask, modelData{mm}.imgMask, models{mm}.params, encRnnFlags, modelData{mm}, models{mm}, 2, []);
    lastEncState2 = encStates2{end};
    [encStates3, modelData{mm}, ~] = rnnLayerForward_enc(models{mm}.b_img, models{mm}.W_img, models{mm}.W_src, models{mm}.W_emb_src, zeroStates{mm}, modelData{mm}.srcInput, ...
      modelData{mm}.srcMask, modelData{mm}.imgMask, models{mm}.params, encRnnFlags, modelData{mm}, models{mm}, 3, []);
    lastEncState3 = encStates3{end};
  
    prevStates{mm} = encoder_fusion(lastEncState1, lastEncState2, lastEncState3);
    %prevStates{mm} = encStates1{end};
