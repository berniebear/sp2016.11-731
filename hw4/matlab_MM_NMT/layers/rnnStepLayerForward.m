function [nextState, attnInfo] = rnnStepLayerForward(W_rnn, input_emb, prevState, mask, params, rnnFlags, attnData, model, dropoutmask)
...
for ll=1:numLayers % layer
  ...
  if isempty(dropoutmask)==0
      [nextState{ll}] = lstmUnitForward(W_rnn{ll}, x_t, h_t_1, c_t_1, params, rnnFlags, dropoutmask);
  else
